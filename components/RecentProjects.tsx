  ...
  return (
    <div className="py-20" id="projects">
        ...
        <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
            ...
            <div key={id} className='lg:min-h-[41rem] h-[32rem] flex items-center justify-center sm:w-[570px] w-[80vw] '>
                <PinContainer title={link} href={link}>
                    ...
                    <div>
                        ...
                        <p className='lg:text-xl lg:font-normal font-ight text-sm line-clamp-2'>{des}</p>
                    </div>
